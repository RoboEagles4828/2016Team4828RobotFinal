...
//	private SendableChooser obstacleChooser;
	...
	public void robotInit() {
		...
		autoChooser.addDefault("Terrain", AutoChoice.TERRAIN);
		autoChooser.addDefault("Corner Shot", AutoChoice.CORNERSHOT);
...
//	}
	...
	private enum AutoChoice {
		TERRAIN("Terrain"), CORNERSHOT("Corner Shot");
		private final String stringVal;
		AutoChoice(String v) {
			stringVal = v;
		}
...
//			}
			...
			//shooter.shootAuto();
			//terrain
			if (autoChooser.getSelected()==AutoChoice.TERRAIN) {
				rd.autoHack();
				Timer.delay(2.4);
				rd.stop();
				//Timer.delay(6);
